			...
			>
				...
				<div className='my-[14px] flex justify-center gap-3'>
					<button
						...
						className={`flex min-h-[36px] flex-grow items-center justify-center rounded-[5px] duration-200 ${isClicked && 'bg-[#EAE8FF] bg-opacity-80'} text-base font-semibold hover:bg-[#EAE8FF] hover:bg-opacity-80`}
					>
						팔로워
					</button>
					<button
				...
				<ul className='min-h-[61vh] rounded-[15px] bg-[#EAE8FF] bg-opacity-20 px-[23px] py-[8px]'>
					{Array.from({ length: 4 }).map((_, i) => (
						<li className='my-[15px] flex items-center justify-between' key={i}>
							...
							<button className='h-[20px] w-[54px] rounded-[4px] bg-[#FFBFD3] text-[10px] font-semibold text-[#FFFFFF] active:scale-95'>
